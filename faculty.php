...
<form id="msform" action="index.php" method="POST">
  ...
  <fieldset>
    ...
    <select name="dept" value="Department">
  ...
  <fieldset>
    ...
    <input type="text" name="ctype" placeholder="Complaint Type" required/>
    <textarea name="complaint" placeholder="Complaint"rows="12" required></textarea>
    <input type="button" name="previous" class="previous action-button" value="Previous" />
    <input type="submit" name="submit_faculty" class="submit action-button" value="Submit" />
  </fieldset>
</form>
</body>
</html>